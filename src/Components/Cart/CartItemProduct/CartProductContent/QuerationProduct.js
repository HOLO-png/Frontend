...
import { convertPriceToToken } from "../../../../utils";
  ...
  return (
    <Col className="gutter-row" span={3}>
      <Dropdown
        overlay={menu([
          {
            price: convertPriceToToken(
              product.priceOld === "0" ? product.price : product.priceOld
            ),

            title: "Giá cũ",
            unit: user?.addressWallet ? "Token" : "đ",
          },
          {
            price: convertPriceToToken(
            ...
            title: product.priceOld - product.price < 0 ? " " : "Giảm được",
            unit: user?.addressWallet
              ? "Token"
              : product.priceOld - product.price < 0
              ? " "
              : "đ",
        ...
        <div
          ...
          style={{
            ...
            border:
              ...
              "3px solid #7fc4ec",
            color:
              statusSearchSimilar && activeSearchSimilar === index && "#969696",
          }}
          onClick={() => handleShowSearchProductActive(index, product)}
        >
          <a className="ant-dropdown-link">
            Tìm Sản Phẩm Tương Tự <i className="fab fa-product-hunt"></i>
            <br />
          </a>
        </div>
      </Tooltip>
